...
for fnum in range(0, 10):
    outfile = open(f"llama3-70b/llama3_70b_{fnum}.txt", "w")

    response = ollama.generate(model=model, prompt='''T'The following text is a medieval medical treatise written in Old French, around the 12th-13th centuries.
